        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-xl shadow-slate-200/50 sm:p-8">
          ...
          <form className="space-y-5" onSubmit={handleSubmit} noValidate>
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-800" htmlFor="roomCode">
                방 코드
              </label>
              <input
                aria-describedby={fieldErrors.roomCode ? "room-code-error" : undefined}
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-800" htmlFor="displayName">
                표시 이름
              </label>
              <input
                aria-describedby={
